...
The general performance of a subset seems to average out to the same. For the other Training sets similar results were observed and thus we do not visualize these.
