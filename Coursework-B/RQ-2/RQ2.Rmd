...
We read the data and create the resevent subset (d) for the current research quetsion. We are **not** going to analyse the baselines here because we *only want to observe effect of different strategies when learning from ***multiple TrD**
```{r}
library('ggplot2')
library('emmeans')
