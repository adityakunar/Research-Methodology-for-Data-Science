...
2. Is there an affect on the mood of an individual based on the treatment and does the mood then have any correspondance to the depression score?
...
2. We conduct a pre test for both sample groups by making the subjects fill out a questionnaire corresponding to the HAM-D test and subsequently there after we conduct the profile of mood states assessment as well, however at this stage no treatment has been provided to the experimental group.
